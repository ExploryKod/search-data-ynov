                    ...
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        ...
                        <main className="mt-6">
                            <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                <article className={"flex flex-wrap items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]"}>
                                        ...
                                        >
                                            ...
                                            <div className="pt-3 sm:pt-5 lg:pt-0">
                                                ...
                                                <p className="mt-4 text-sm/relaxed">
                                                    Ce POC illustre l'intégration d'Algolia dans un projet Laravel
                                                    pour implémenter une recherche rapide et performante des
                                                    produits.
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div
                                        className="my-5 relative gap-4 flex w-full flex-1 items-stretch"
                                    >
                                        {auth.user ? (
                                            <Link
                                                href={route('dashboard')}
                                ...
                                <a
                                    href="https://www.algolia.com/doc/framework-integration/laravel/getting-started/introduction-to-scout-extended/"
                                ...
                                >
                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        ...
                                        <p className="mt-4 text-sm/relaxed">
                                            Nous pouvons intégrer Algolia dans votre projet Laravel via Scout pour créer
                                            des recherches instantanées avec une interface intuitive.
                                        </p>
                                    </div>
                                ...
                                >
                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        ...
                                        <p className="mt-4 text-sm/relaxed">
                                            Laravel News fournit des informations importantes sur l'écosystème Laravel,
                                            y compris des mises à jour de packages et des tutoriels sur l'intégration
                                            d'Algolia.
                                        </p>
                                    </div>
                                ...
                                <div
                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        ...
                                        <p className="mt-4 text-sm/relaxed">
                                            Scout est un package Laravel pour faciliter la recherche instantanée avec
                                            Elasticsearch, Algolia ou Sphinx. Vous pouvez l'utiliser pour indexer des
                                            données dans votre base de données et effectuer des recherches sur les
                                            données.
                                        </p>
                                    </div>
                                </div>
